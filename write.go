...
func writeFetchRequestV2(w *bufio.Writer, correlationID int32, clientID string, topic string, partition int32, offset int64, minBytes int, maxBytes int, maxWait time.Duration) error {
	h := requestHeader{
...
func writeProduceRequestV2(w *bufio.Writer, codec CompressionCodec, correlationID int32, clientID string, topic string, partition int32, timeout time.Duration, requiredAcks int16, msgs ...Message) error {
	var size int32
